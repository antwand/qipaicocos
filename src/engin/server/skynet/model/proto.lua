local sprotoparser = require "engin.server.skynet.sproto.sprotoparser"
...
auth 1 {
  request {
    userName 0 : string             #微信账号传unionID，没有传空字符串
    thirdToken 1 : string           #微信账号传code，没有传空字符串
    thirdPlatformID 2 : integer     #----- huang xiang rui 第三方ID 2015.10.03
        ...
        spreader  7 : string            #绑定在安装包中的推广号
        newSpreader 8 : string          #房间推广号
    }
    response {
